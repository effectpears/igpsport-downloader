...
It is designed to be run periodically and features automatic deduplication, HTTP retries, and log rotation. It checks the **last N activities**, so it should typically run at least frequently enough to cause overlaps.
...
IGPSPORT_ACTIVITY_LIMIT=3        # => checks last 3 Activities
